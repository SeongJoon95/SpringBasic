package com.seongjoon.springbasic.repository;
...
extends JpaRepository<SampleUserEntity, String> {
    ...
    List<SampleUserEntity> findByName(String name); // == SELECT * FROM sample_user where name = '값' ;
    // telNumber은 not null + unique 이기때문에 0 or 1 이 나와서 List로 받을 필요 x
