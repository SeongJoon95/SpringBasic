package com.seongjoon.springbasic.provider;
...
// - 인증 및 인가
// - 암호화가 되어 있어 클라이언트와 서브 간에 안전한 데이터 전달을 수행할 수 있음
...
public class JwtProvider {
    ...
    public String create(String name) {
        ...
        // 비밀키 생성
        // String secretKey = "qwertyuiopasdfghjkl12345678901234567890dsksddyfjksdyh7i";
